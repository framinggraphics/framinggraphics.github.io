...
function contentFilter(filterID, filterType){  
	var id = filterID;
	document.querySelector('.filter-categories').onclick = function(evt) { 
...
contentFilter('#gallery', 'inclusive'); // gallery init - params: unique wrapper id, filter type (inclusive/exclusive) */
